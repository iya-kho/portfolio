export const projectsData = [
  {
    ...
    description:
      ...
      `A comprehensive tutorial on building a REST API using Ubos, a low-code platform. Developed in Oxygen XML using DITA architecture and published with a customized web output template.`,
    picture: 'ubos_docs.webp',
    tools: [
      'Technician communication in English',
      'DITA',
      'Oxygen XML',
    ...
    codeLink: 'https://github.com/iya-kho/ubos-docs',
  },
  {
  ...
  },
  {
    ...
    webLink: {
      link: 'https://iya-kho.github.io/hlegal',
      isActive: true
    },
